...
export default function Services() {
    return (
        <>
            <div className="bg-white p-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 max-w-7xl mx-auto min-w-full my-6">
                    <Box
                        ...
                        description="Break free from the grip of stress and overwhelm. Through mindfulness and evidence-based strategies, discover a calm and centered version of yourself."
            ...
            <img className="absolute bottom-0 right-0 scale-x-[-1] z-[1] hidden md:flex md:max-h-[150px] md:max-w-[100px] lg:max-h-[250px] lg:max-w-[150px] xl:max-w-[200px] xl:max-h-[300px] xl:right-[5%]" src="/serviceimages/plant.webp"></img>
        </>
    );
}
